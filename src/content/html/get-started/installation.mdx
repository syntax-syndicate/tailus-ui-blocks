---
title: Installation
description: Learn how to install Tailus UI React in your project.
priorityOrder : 2
---
...
export const utils = [
    {
        code: "mkdir src/lib && touch src/lib/utils.ts",
        lang : "bash"
    },
    {
...
<div className="space-y-20">
    ...
    <div>
        ...
        <div>
            ...
            <CodeSnippet code="npm install @tailus/themer tailwind-merge lucide-react" lang="bash" client:visible/>
        </div>
        ...
        <div>
            ...
            <DocsStackedSnippets snippets={utils} client:visible />
            ...
            <Banner.Root intent="gray" className="border-none mt-6">
                <Banner.Content>
                    ...
                    <div className="space-y-3 -mb-4">
                        <Title as="h3" size="base" weight="medium">Note</Title>
                        <Text className="[--body-text-color:theme(colors.gray.700)] dark:[--body-text-color:theme(colors.gray.300)]">
                            The `cloneElement()` is used to clone a React element and add Tailwind CSS utilities to the cloned element. It's useful for the `<Icon />` part of some components
                        </Text>
                    </div>
                </Banner.Content>
            </Banner.Root>
        ...
        <div>
            ...
            <CodeSnippet {...paths} client:visible/>
        </div>
    </div>
    </div>
    ...
    <div>
        ...
        Great job! You've successfully installed Tailus UI in your project. Next, let's learn how to configure your [theme](/react/theming/theme-config).
    </div>
