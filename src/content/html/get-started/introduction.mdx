---
title: Introduction
description: Modern HTML UI Kit for building custom web UIs
priorityOrder : 1
---
...
Tailus UI HTML is a collection of highly customizable, accessible modern react components built on top of [Radix UI](https://radix-ui.com/primitives) and [Tailwind Css](https://tailwindcss.com). 
