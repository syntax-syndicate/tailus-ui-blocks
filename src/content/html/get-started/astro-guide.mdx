---
title: Astro Guide
description: Install and Configure Tailus UI React with Astro
priorityOrder : 11
---
...
<div>
    ...
    <CodeSnippet {...config} code={`npm create astro@latest astrolus
...
<div>
    ...
    <CodeSnippet {...config} code="npx astro add tailwind react" client:visible />
</div>
