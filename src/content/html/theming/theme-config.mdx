...
export const palette = [
    {
        code: `import { palettes } from "@tailus/themer"`,
        lang: "ts",
    },
    {
    code: `theme: {
...
export const rounded = [
    {
        code: `import { palettes, rounded } from "@tailus/themer"`,
        lang: "ts",
    },
    {
    code: `theme: {
...
export const componentsCode = [
    {
        code: `import { palettes, rounded, shade, components } from "@tailus/themer"`,
        lang: "ts",
    },
    {
    code: `theme: {
...
export const animations = [
    {
        code: `import { palettes, rounded, shade, components, animations } from "@tailus/themer"`,
        lang: "ts",
    },
    {
    code: `theme: {
...
<div className="space-y-20">
    ...
    <div>
        ...
        Learn more about customizing the palette on the [Palette](/react/theming/palette) page.
    </div>
    <div>
        ## Border Radius
        ...
        Learn more about customizing the border radius on the [Rounded](/react/theming/rounded) page.
    </div>
    ...
    <div>
        ...
        <DocsStackedSnippets snippets={componentsCode} client:visible />
    ...
    <div>
        ...
        <DocsStackedSnippets snippets={animations} client:visible />
    ...
    <div>
        ...
        <CodeSnippet {...visualizations} client:visible />
