...
import { Code, Text, Title, Link } from "@components/typography"
...
<div className="space-y-20">
    <div>
        ...
        <CodeSnippet code="npm install recharts" lang="bash" />

        <Link href="/react-visualizations.zip" download>Download</Link> and place visualization components in **tailus-ui/visualizations** folder or install each component individually.
