---
title: Laravel Guide
description: Install and Configure Tailus UI React with Laravel
priorityOrder : 13
---
...
export const utils = [
    {
        code: "mkdir ressources/js/lib && touch ressources/js/lib/utils.ts",
        lang : "bash"
    },
    {
...
<div>
    ...
    <CodeSnippet {...config} code="laravel new larus --typescript --breeze --stack=react --git --no-interaction
cd larus" client:visible />
</div>
...
<div>
    ...
    <CodeSnippet {...config} code="npm install -D tailwindcss postcss autoprefixer gatsby-plugin-postcss
npx tailwindcss init -p" client:visible />
</div>
...
<div>
    ...
    <CodeSnippet {...config} code="npm install @tailus/themer tailwind-merge lucide-react" client:visible />
</div>
...
<div>
    ...
    <CodeSnippet {...config} highlightedLines="2-8" client:visible />
</div>
...
<div>
    ...
    Great job! You've successfully installed Tailus UI React in your project. Next, let's learn how to configure your [theme](/react/theming/theme-config).
</div>
