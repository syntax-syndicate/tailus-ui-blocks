---
title: NextJs Guide
description: Install and Configure Tailus UI React with NextJs
priorityOrder : 14
---
...
export const utils = [
    {
        code: "mkdir lib && touch lib/utils.ts",
        lang : "bash"
    },
    {
...
<div>
    ...
    <CodeSnippet {...config} code="npx create-next-app@latest my-project --typescript --eslint
cd my-project" client:visible />
</div>
...
<div>
    ...
    <CodeSnippet {...config} code="npm install -D tailwindcss postcss autoprefixer
...
<div>
    ...
    <CodeSnippet {...config} highlightedLines="2-11" client:visible />
</div>
...
<div>
    ...
    <CodeSnippet code={`// global.css

@tailwind base;
@tailwind components;
@tailwind utilities;`} lang="css" client:visible />
</div>
