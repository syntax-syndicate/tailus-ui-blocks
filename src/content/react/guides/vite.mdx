---
title: Vite Guide
description: Install and Configure Tailus UI React with Vite
priorityOrder : 16
---
...
<div>
    ...
    <CodeSnippet {...config} code="npm create vite@latest my-project -- --template react
...
<div>
    ...
    <CodeSnippet {...config} highlightedLines="2-6" client:visible />
</div>
