---
title: Remix Guide
description: Install and Configure Tailus UI React with Remix
priorityOrder : 15
---
...
<div>
    ...
    <CodeSnippet {...config} code="npx create-remix@latest remus
cd remus" client:visible />
</div>
...
npx tailwindcss init --ts -p" client:visible />
</div>
...
<div>
    ...
    <CodeSnippet {...config} highlightedLines="2-5" client:visible />
</div>
