---
title: Gatsby Guide
description: Install and Configure Tailus UI React with Gatsby
priorityOrder : 12
---
...
<div>
    ...
    <CodeSnippet {...config} code="gatsby new my-project
...
<div>
    ...
    <CodeSnippet code={`// gatsby-config.js
