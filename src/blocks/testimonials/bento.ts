...
const htmlCode = `<section class="py-32">
    <div class="mx-auto max-w-5xl space-y-16 px-6">
        ...
        <div class="grid gap-4 sm:grid-cols-2 md:grid-cols-4 lg:grid-rows-2">
            <div class="card variant-mixed grid gap-8 [grid-template-rows:auto_1fr] sm:col-span-2 lg:row-span-2 lg:p-12">
            ...
            <div class="card variant-mixed sm:col-span-2 lg:p-12">
        ...
        <section className="py-32">
            <div className="mx-auto max-w-5xl space-y-16 px-6">
                ...
                <div className="grid gap-4 sm:grid-cols-2 md:grid-cols-4 lg:grid-rows-2">
                    <div className="card variant-mixed grid gap-8 [grid-template-rows:auto_1fr] sm:col-span-2 lg:row-span-2 lg:p-12">
                    ...
                    <div className="card variant-mixed sm:col-span-2 lg:p-12">
                    ...
                    <div className="card variant-mixed">
