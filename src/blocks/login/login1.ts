        ...
        <section class="flex min-h-screen">
            <form action="" class="card bg-ui tls-shadow-md m-auto h-fit w-full max-w-sm p-1">
                <div class="p-8">
                    ...
                    <div class="space-y-6">
                        <div class="field">
                            <label htmFor="email2" class="text-title text-sm"> Username</label>
                            <input type="email" required name="email2" id="email2" class="input sz-md variant-mixed" />
                        </div>

                        <div class="field">
                            <div class="flex justify-between">
                                <label htmFor="pwd" class="text-title text-sm"> Password</label>
                                <Link href="#" class="link intent-info variant-ghost text-sm"> Forgot your Password ?</Link>
                            </div>
                            <input type="password" required name="pwd" id="pwd" class="input sz-md variant-mixed" />
                        </div>
                ...
                <div data-shade="925" class="card variant-soft rounded-[calc(var(--card-radius)-4px)] dark:!bg-[--ui-bg]">
                    <p class="text-center text-sm">
                        Don't have an account ?
                        <Link href="#" class="link intent-neutral variant-underlined"> Create account</Link>
                    </p>
                </div>
            </form>
        </section>
