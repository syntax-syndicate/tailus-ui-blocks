...
const component = `import * as DropdownMenuPrimitive from "@radix-ui/react-dropdown-menu";
...
const usageCode = `export default () => (
  <ContextMenu.Root>
    <ContextMenu.Trigger />
...
export const usage = [
  {
    code: 'import DropdownMenu from "@tailus-ui/DropdownMenu";',
    lang: "tsx",
  },
  {
    code: overviewCode[0].code,
    lang: "tsx",
  }
]
