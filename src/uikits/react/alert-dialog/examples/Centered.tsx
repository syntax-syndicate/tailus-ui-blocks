...
export const Centered = ({mixed=false, fancy=false} : {mixed?:boolean, fancy?:boolean}) => (
    <AlertDialog.Root>
      ...
      <AlertDialog.Portal>
        ...
        <AlertDialog.Content className="max-w-md z-50" fancy={fancy} mixed={mixed} data-shade="800">
