...
export default function Footer() {
    ...
    return (
        <footer className="rounded-xl border">
            <div className="mx-auto max-w-4xl space-y-16 px-6 py-8 text-gray-600 sm:px-12 lg:py-16 2xl:px-0">
                <div className="flex flex-wrap items-center justify-between gap-4 border-b pb-8 dark:border-gray-800">
                    <a href="/" aria-label="tailus logo">
                        <svg className="h-7 text-gray-950 dark:text-white" viewBox="0 0 298 84" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
