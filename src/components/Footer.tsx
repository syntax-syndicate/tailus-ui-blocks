...
import { Link, Title } from "./typography";
...
export default function Footer() {
    ...
    const templatesLinks: { url: string, label: string }[] = [
        {url: "/templates/ampire/", label: 'Ampire'},
        { url: "/templates/radiant/", label: 'Radiant' },
        { url: "/templates/astrolus/", label: 'Astrolus' },
        { url: "/templates", label: 'All templates' },
    ];

    const uikits: { url: string, label: string }[] = [
        {url: "/react/get-started/introduction", label: 'React'},
        { url: "/html/get-started/introduction", label: 'HTML' },
        {url: "/astro/get-started/introduction", label: 'Astro'},
        {url: "/symfony/get-started/introduction", label: 'Symfony'},
    ];
    ...
    return (
        <footer className="rounded-xl border">
            <div className="mx-auto max-w-4xl px-6 sm:px-12 space-y-16 py-8 lg:py-16 text-gray-600 2xl:px-0">
                <div className="flex flex-wrap items-center justify-between gap-4 border-b pb-8 dark:border-gray-800">
                    ...
                    <div className="flex gap-3">
                        <a href={SITE_SOCIAL_GITHUB} target="blank" aria-label="github" className="size-8 flex *:m-auto rounded-[--btn-border-radius] text-gray-600 dark:text-gray-400 hover:text-primary-600 dark:hover:text-primary-500">
                        ...
                        <a href={SITE_SOCIAL_TWITTER} target="blank" aria-label="twitter" className="size-8 flex *:m-auto rounded-[--btn-border-radius] text-gray-600 dark:text-gray-400 hover:text-primary-600 dark:hover:text-primary-500">
                        ...
                        <a href={SITE_SOCIAL_YOUTUBE} target="blank" aria-label="medium" className="size-8 flex *:m-auto rounded-[--btn-border-radius] text-gray-600 dark:text-gray-400 hover:text-primary-600 dark:hover:text-primary-500">
                ...
                <div className="grid grid-cols-2 gap-6 sm:grid-cols-4">
                    {
                        footer.map((col) => (
                            <div>
                                <Title as="h3" className="text-sm" weight="medium">{col.title}</Title>
                ...
                <div>
                    <div className="-mb-2 text-sm flex flex-wrap gap-1 overflow-hidden font-medium text-gray-700 dark:text-gray-300">
                        Designed by Tailus UI in
                        <div className="flex items-start justify-center gap-2 text-center font-semibold text-gray-950 dark:text-white sm:gap-1">
                            <div className="block">
