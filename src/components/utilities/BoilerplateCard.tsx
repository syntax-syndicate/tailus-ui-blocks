...
const BoilerplateCard: React.FC<BoilerplateCardProps> = ({
    ...
    return (
        <a className="rounded-[--card-radius] p-[--card-padding] border bg-[--ui-bg] card-shadow [--card-shadow-opacity:0] hover:[--card-shadow-opacity:0.05] dark:[--card-shadow-opacity:0.25] dark:hover:[--card-shadow-opacity:0.5] transition-[box-shadow] duration-300" href={href} target={isBlank && "_blank"}>
            ...
            <Text neutral weight="medium" size="lg" className="capitalize mb-0 mt-3" align="center">{framework}</Text>
        </a>
    )
}
