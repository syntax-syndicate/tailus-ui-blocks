...
export const HeadingOne = ({ children, id }) => {
    return (
        <h1 id={id} className="scroll-my-32 mt-3 text-xl sm:text-2xl font-semibold text-[--title-text-color]">
            {children}
        </h1>
    )
}
...
export const HeadingThree = ({children, id, className=""}) => {
    return (
        <h3 id={id} className={cn("scroll-my-32 mt-4 text-base font-medium text-[--title-text-color]", className)}>
            {children}
        </h3>
    )
}
...
export const HeadingFive = ({children, id}) => {
    return (
        <h5 id={id} className="scroll-my-32 mb-8 mt-4 text-base font-medium text-[--title-text-color]">
            {children}
        </h5>
    )
}
...
export const HeadingSix = ({children, id}) => {
    return (
        <h6 id={id} className="scroll-my-32 mb-8 mt-4 text-base font-medium text-[--title-text-color]">
            {children}
        </h6>
    )
}
