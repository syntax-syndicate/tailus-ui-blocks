...
export const ProgressiveBlur = ({ children }: { children:ReactNode}) => {
  return (
    <>
      <div className="fixed bottom-0 flex h-[calc(100vh-5.75rem)] lg:h-[calc(100vh-4rem)] mt-auto w-screen items-center justify-center overflow-auto">
        <div
        ...
        <div className="pointer-events-none absolute left-0 lg:left-72 xl:left-80 right-0 top-0 z-10 h-16 w-full">
            <BlurDivs />
        </div>
      </div>
    </>
