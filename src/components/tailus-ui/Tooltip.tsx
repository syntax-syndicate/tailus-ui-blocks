...
const TooltipContent = React.forwardRef<React.ElementRef<typeof TooltipPrimitive.Content>, React.ComponentPropsWithoutRef<typeof TooltipPrimitive.Content> & TooltipProps>(({ className, fancy = false, inverted = true, sideOffset = 4, ...props }, ref) => {
...
const TooltipArrow = React.forwardRef<SVGSVGElement, React.ComponentPropsWithoutRef<typeof TooltipPrimitive.Arrow> & TooltipProps>(({ fancy, inverted, className, ...props }) => {
    const { arrow } = tooltip();
