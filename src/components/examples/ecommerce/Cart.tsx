...
const Item: React.FC<ItemType> = ({ name, category, shortDescription, price, priceUnit = '$', oldPrice, link, image, onDelete }) => (
    <div className="grid gap-3 border-b py-4 [grid-template-columns:auto_1fr] first:pt-0 last:border-b-0 last:pb-0">
        <a href={link} aria-label={`Go to ${name}`} className="block w-24">
            <AspectRatio ratio={1 / 1} className="relative overflow-hidden rounded-[--card-radius] before:absolute before:inset-0 before:z-[1] before:bg-gray-100 before:mix-blend-darken">
    ...
    return (
        <Drawer.Root direction="right">
            ...
            <Drawer.Portal>
                ...
                <Drawer.Content withControler={false} className="z-20 grid w-full max-w-md [grid-template-rows:auto_1fr_auto] before:hidden dark:border-l" data-shade="950">
                    ...
                    {cartProducts.length > 0 && (
                        <div className="mt-auto border-t pt-6">
                            <div className="space-y-1 divide-y *:py-2 first:*:mt-0 first:*:pt-0 last:*:pb-0">
                                <div className="flex justify-between">
                                    <Text as="div" size="sm" weight="medium" className="my-0">
                                        Subtotal
                                    </Text>
                                    <Text as="span" size="sm" className="my-0">
                                        $78
                                    </Text>
                                </div>
                                <div className="flex justify-between">
                                    <div className="flex items-center gap-2">
                                        <Text as="div" weight="medium" size="sm" className="my-0">
                                            Estimated Tax
                                        </Text>
                                        <Popover.Root>
                                ...
                                <div className="flex justify-between">
                                    <Title as="div" weight="medium" className="my-0 text-sm">
                                        Total
                                    </Title>
                                    <Text as="span" size="sm" className="my-0">
                                        $708
