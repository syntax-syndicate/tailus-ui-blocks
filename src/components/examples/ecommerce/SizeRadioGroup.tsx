...
export const RadioCard = ({ value, children }) => (
    <Label htmlFor={value} size="sm" className="-ring-offset-px block rounded-[--card-radius] border bg-[--ui-bg] p-[--card-padding] ring-primary-600 has-[[data-state='checked']]:ring-2 dark:has-[[data-state='checked']]:bg-[--ui-soft-bg]">
        {children}
