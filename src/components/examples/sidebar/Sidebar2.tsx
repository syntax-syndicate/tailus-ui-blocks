...
export const Sidebar2 = () => {
    ...
    return (
        <div className="grid [grid-template-columns:auto_1fr] w-full">
            <div className="flex divide-x sm:border-r rounded-r-[--card-radius] md:rounded-none">
                <div data-shade="950" className="flex flex-col gap-4 h-[75vh] p-4 bg-[--ui-bg] rounded-l-[--card-radius]">
                ...
                <div data-shade="900" className="sm:w-80 bg-[--ui-bg] p-4 space-y-4 rounded-r-[--card-radius] md:rounded-none">
            ...
            <div data-shade="925" hidden className="md:block h-[75vh] bg-[--ui-bg] overflow-hidden rounded-r-[--card-radius]">
                ...
                <Tabs.Root className="h-[calc(100%-4.2rem)]" defaultValue={state} onValueChange={(value) => setState(value as TabsAppProps)}>
                    <div data-shade="900" className="border-b bg-[--ui-bg]">
                        <Tabs.List variant="plain" triggerVariant="plain" size="sm" className="px-4 gap-1.5 w-fit pb-1">
                            <Tabs.Indicator ref={spanRef} variant="bottom" intent="primary"/>
