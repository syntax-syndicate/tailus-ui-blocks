    ...
    return (
        <Tabs.Root defaultValue="all" className="space-y-4 -mx-3">
            ...
            <Tabs.Content value="all" className="space-y-1">
                <ChatLink userName="Méschac Irung" avatar="https://pbs.twimg.com/profile_images/1767582956082561024/TLJvxR_V_400x400.jpg" lastMessage="Hello, how are you doing today?" date="12:00 PM" link="#" />
                <ChatLink isUnread userName="Tailus UI" avatar="https://mars-images.imgix.net/1704976070160-1704976065843icon.png?auto=compress&fit=max&w=128" lastMessage="Hello, how are you doing today?" date="12:00 PM" link="#" />
                ...
                <ChatLink isUnread userName="Théo Balick" avatar="https://pbs.twimg.com/profile_images/1679957923823247360/47FJpyBb_400x400.jpg" lastMessage="Good news ! I'll be working on the CLI this week" date="20 May" link="#" />
            </Tabs.Content>
    ...
    <Popover.Root>
        <Popover.Trigger asChild>
            <div className="relative">
                <span className="block absolute top-2.5 right-2.5 size-1.5 ring-2 ring-white dark:ring-gray-925 rounded-full bg-danger-600"></span>
